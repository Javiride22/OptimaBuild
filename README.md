...
La mayor frustración y el principal problema es que la mayoría de los jugadores no tienen tiempo suficiente para estar todo el día probando clases y habilidades y esto puede desencadenar en la elección de una serie de talentos que terminan haciendo del juego un sufrimiento en el que no puedes avanzar, optando al final por dejar de jugarlo o reiniciar otra partida y haber perdido todo el tiempo y a veces incluso el dinero de comprar el juego.
